...
// Playfair Display for Christian App
 ...
 *    className="font-playfair" or className="font-serif"
 * 
 * 2. In styled-components:
 *    font-family: ${fontFamilies.playfair};
 * 
 * 3. In component styles:
 *    style={{ fontFamily: fontFamilies.playfair }}
 * 
